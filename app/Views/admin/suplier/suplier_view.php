			...
			<div class="col-md-12">
				...
				<div class="card card-secondary">
					<div class="card-header">
						<h3 class="card-title"><i class="fas fa-store-alt"></i> Data Suplier</h3>
							...
							<table id="simple-table" class="table  table-bordered table-hover">
								<thead>
									<tr>
										...
										<th style="width:3px">No Tlpn</th>
										<th style="width:3px">Hp Sales</th>
								...
								<tbody>
									<?php if ($suplier) : ?>
										<?php
										$no = 1;
										foreach ($suplier as $mbeli) : ?>
											<tr>
												<td><?php echo $no; ?></td>
												<td><?php echo $mbeli->nama_suplier; ?></td>
												<td><?php echo $mbeli->alamat; ?></td>
												<td><?php echo $mbeli->no_tlpn; ?></td>
												<td><?php echo $mbeli->sales_hp; ?></td>
												<td><?php echo date("d-m-Y", strtotime($mbeli->created_date)); ?></td>
												<td><?php echo $mbeli->keterangan; ?></td>
												<td>
													<div>
														<a href="suplier/detail/<?= $mbeli->id_suplier; ?>" type="button" href=class="btn-xs btn-outline-success small"> <i class="fa fa-eye"></i></a>
														<button style="margin: 5px;" type="button" class="btn-xs btn-outline-danger small btn-delete" data-idsuplier="<?= $mbeli->id_suplier; ?> "><i class="fa fa-trash"></i></button>
														<button type="button" class="btn-xs	 btn-outline-success small btn-edit" data-idsuplier="<?= $mbeli->id_suplier; ?>" data-namasuplier="<?= $mbeli->nama_suplier; ?>" data-alamat="<?= $mbeli->alamat; ?>" data-tlpn="<?= $mbeli->no_tlpn; ?>" data-hp="<?= $mbeli->sales_hp; ?>" data-ket="<?= $mbeli->keterangan; ?>"  "><i class="fa fa-edit"></i></button>
													</div>
												</td>
											</tr>
										<?php
...
<!-- Bootstrap modal -->
<form action="<?= base_url('suplier/add') ?>" method="post">
					...
					<form action="#" id="form_addprod" class="form-horizontal">
						...
						<div class="form-body">
							<div class="form-group">
								...
								<div class="col-md-9">
									<input name="nama_suplier" placeholder="nama suplier" requeired id="nama_suplier" class="form-control" type="text">
							...
							<div class="form-group">
								...
								<div class="col-md-9">
									<input name="no_tlpn" id="no_tlpn" placeholder="085xxxx" class="form-control" type="number">
									<span class="help-block"></span>
								</div>
							</div>
							<hr></hr>
							...
							<div class="form-group">
								...
								<div class="col-md-9">
									<input name="nama_sales" id="nama_sales"  class="form-control" type="text">
									<span class="help-block"></span>
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-md-9">
									<input name="no_sales" id="no_sales" placeholder="085xxxx" class="form-control" type="number">
									<span class="help-block"></span>
								</div>
							</div>
