			...
			<div class="col-md-12">
				...
				<div class="card card-secondary">
					<div class="card-header">
						<h3 class="card-title"><i class="fas fa-store-alt"></i> Kategori Produk </h3>
							...
							<table id="simple-table" class="table  table-bordered table-hover">
								...
								<tbody>
									<?php if ($kategoriprod) : ?>
										<?php
										$no = 1;
										foreach ($kategoriprod as $mdata) : ?>
											<tr>
												<td><?php echo $no; ?></td>
												<td><?php echo $mdata->kategori; ?></td>
												<td><?php echo $mdata->slug; ?></td>
				...
				<div class="modal-body form">
					...
					<form action="#" id="form_addprod" class="form-horizontal">
						...
						<div class="form-body">
							...
							<div class="form-group">
								<label class="control-label col-md-6">Slug / Keterangan</label>
								<div class="col-md-9">
									<input name="slug" placeholder="nama roles" requeired id="slug" class="form-control" type="text">
									<span class="help-block"></span>
								</div>
							</div>
						</div>
